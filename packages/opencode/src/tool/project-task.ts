...
const CreateParams = Schema.Struct({
  ...
  description: Schema.optional(Schema.String).annotate({
    description:
      "Longer description / acceptance notes. Written to `.project-tasks/<taskID>/prd.md` (see descriptionPath).",
  }),
...
const UpdateParams = Schema.Struct({
  ...
  description: Schema.optional(Schema.String).annotate({
    description: "New description body; overwrites `.project-tasks/<taskID>/prd.md`",
  }),
