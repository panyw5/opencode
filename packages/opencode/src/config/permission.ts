...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    scheduled_task_list: Schema.optional(Action),
    ...
    im_list: Schema.optional(Action),
    im_read: Schema.optional(Action),
    im_send: Schema.optional(Action),
    im_watch: Schema.optional(Action),
