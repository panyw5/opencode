    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const defaults = Permission.fromConfig({
          ...
          math_worker_task_update: "deny",
          math_gm_add: "deny",
          math_gm_search: "deny",
          math_fact_search: "deny",
          math_fact_get: "deny",
          math_fact_revoke: "deny",
          math_fact_submit: "deny",
          "math-truth_fact_submit": "deny",
          skill: {
            "*": "allow",
          ...
          "math-orchestrator": {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                math_worker_task_update: "allow",
                math_gm_add: "allow",
                math_gm_search: "allow",
                math_fact_search: "allow",
                math_fact_get: "allow",
                math_fact_revoke: "allow",
              }),
              user,
            ),
          },
