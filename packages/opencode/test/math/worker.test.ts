...
describe("math.agents", () => {
  it.instance("math-worker cannot nest task or run bash; orchestrator can start workers", () =>
    Effect.gen(function* () {
      ...
      expect(Permission.evaluate("math_worker_task_update", "*", orch.permission).action).toBe("allow")
      expect(Permission.evaluate("math_gm_add", "*", orch.permission).action).toBe("allow")
      expect(Permission.evaluate("math_gm_search", "*", orch.permission).action).toBe("allow")
      expect(Permission.evaluate("math_fact_search", "*", orch.permission).action).toBe("allow")
      expect(Permission.evaluate("math_fact_get", "*", orch.permission).action).toBe("allow")
      expect(Permission.evaluate("math_fact_revoke", "*", orch.permission).action).toBe("allow")
      expect(Permission.evaluate("math_fact_submit", "*", orch.permission).action).toBe("deny")
      expect(Permission.evaluate("math-truth_fact_submit", "*", orch.permission).action).toBe("deny")
      ...
      expect(Permission.evaluate("math_worker_task_update", "*", build.permission).action).toBe("deny")
      expect(Permission.evaluate("math_gm_add", "*", build.permission).action).toBe("deny")
      expect(Permission.evaluate("math_fact_revoke", "*", worker.permission).action).toBe("deny")
