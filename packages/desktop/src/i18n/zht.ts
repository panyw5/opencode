export const dict = {
  ...
  "desktop.loading.status.failed": "啟動失敗",
  "desktop.loading.progressAria": "資料庫移轉進度",
  "desktop.loading.reload.title": "正在重新載入後端",
  "desktop.loading.reload.message": "正在重新啟動本機後端並刷新其狀態。",
  "desktop.startup.failed.title": "OpenCode 無法啟動本機後端",
  "desktop.startup.failed.message": "修復本機後端問題後，請重新啟動應用程式。",
  "desktop.startup.failed.reloadWebview": "重新啟動前端",
  "desktop.startup.failed.reloadBackend": "重新啟動後端",
  "desktop.startup.failed.restart": "重新啟動應用程式",
  "desktop.startup.failed.checkUpdates": "檢查更新",
