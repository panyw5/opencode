...
const api: ElectronAPI = {
  ...
  setCodexConfig: (config) => ipcRenderer.invoke("set-codex-config", config),
  testCodexConfig: (config) => ipcRenderer.invoke("test-codex-config", config),
  getCodexInfo: (config) => ipcRenderer.invoke("get-codex-info", config),
  getClaudeConfig: () => ipcRenderer.invoke("get-claude-config"),
  setClaudeConfig: (config) => ipcRenderer.invoke("set-claude-config", config),
  testClaudeConfig: (config) => ipcRenderer.invoke("test-claude-config", config),
  getClaudeInfo: (config) => ipcRenderer.invoke("get-claude-info", config),
