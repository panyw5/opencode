...
export const dict = {
  ...
  "ui.sessionTurn.diffs.summary": "{{count}} 个文件发生变动",
  ...
  "ui.sessionTurn.status.sending": "发送中",
  ...
  "ui.tool.codex.streaming": "输出中",
  "ui.tool.codex.view": "查看会话",
  "ui.tool.codex.stop": "停止",
  "ui.tool.codex.dialog.title": "Codex 会话",
  "ui.tool.codex.empty": "暂无会话内容。",
  "ui.tool.codex.empty.running": "等待 Codex 回复…",
  "ui.tool.codex.role.user": "OpenCode",
  "ui.tool.codex.role.assistant": "Codex",
  "ui.tool.codex.role.system": "系统",
  "ui.tool.advisor.intervene": "干预",
  "ui.tool.advisor.intervention.placeholder": "向参谋发送消息",
  "ui.tool.advisor.intervention.send": "发送",
  "ui.tool.advisor.intervention.finish": "结束干预",
  "ui.tool.advisor.intervention.failed": "无法启动参谋干预",
  "ui.tool.claude": "Claude 参谋",
  "ui.tool.claude.running": "会诊中…",
  "ui.tool.claude.streaming": "输出中",
  "ui.tool.claude.view": "查看会话",
  "ui.tool.claude.stop": "停止",
  "ui.tool.claude.dialog.title": "Claude 会话",
  "ui.tool.claude.empty": "暂无会话内容。",
  "ui.tool.claude.empty.running": "等待 Claude 回复…",
  "ui.tool.claude.role.user": "OpenCode",
  "ui.tool.claude.role.assistant": "Claude",
  "ui.tool.claude.role.system": "系统",
  "ui.tool.grok": "Grok 参谋",
  "ui.tool.grok.running": "会诊中…",
  "ui.tool.grok.streaming": "输出中",
  "ui.tool.grok.view": "查看会话",
  "ui.tool.grok.stop": "停止",
  "ui.tool.grok.dialog.title": "Grok 会话",
  "ui.tool.grok.empty": "暂无会话内容。",
  "ui.tool.grok.empty.running": "等待 Grok 回复…",
  "ui.tool.grok.role.user": "OpenCode",
  "ui.tool.grok.role.assistant": "Grok",
  "ui.tool.grok.role.system": "系统",
  "ui.tool.dsh": "DeepSeek 参谋",
  "ui.tool.dsh.running": "会诊中…",
  "ui.tool.dsh.streaming": "输出中",
  "ui.tool.dsh.view": "查看会话",
  "ui.tool.dsh.stop": "停止",
  "ui.tool.dsh.dialog.title": "DeepSeek 会话",
  "ui.tool.dsh.empty": "暂无会话内容。",
  "ui.tool.dsh.empty.running": "等待 DeepSeek 回复…",
  "ui.tool.dsh.role.user": "OpenCode",
  "ui.tool.dsh.role.assistant": "DeepSeek",
  "ui.tool.dsh.role.system": "系统",
  ...
  "ui.message.injection.scheduledPrompt": "{{name}} 计划任务注入提示词",
  "ui.message.injection.scheduledPromptFallback": "计划任务注入提示词",
  "ui.message.injection.projectTaskPrompt": "{{name}} 项目任务注入提示词",
  "ui.message.injection.projectTaskPromptFallback": "项目任务注入提示词",
  "ui.message.injection.backgroundTaskCompleted": "后台任务 {{description}} 已完成",
  "ui.message.injection.backgroundTaskCompletedFallback": "后台任务已完成",
  "ui.message.injection.backgroundTaskFailed": "后台任务 {{description}} 失败",
  "ui.message.injection.backgroundTaskFailedFallback": "后台任务失败",
  "ui.message.injection.backgroundShellCompleted": "后台 Shell {{description}} 已完成",
  "ui.message.injection.backgroundShellCompletedFallback": "后台 Shell 已完成",
  "ui.message.injection.mathWorkerCompleted": "数学工作智能体已完成",
  "ui.message.injection.mathWorkerBlocked": "数学工作智能体已阻塞",
  "ui.message.injection.mathWorkerEvent": "数学工作智能体事件",
