...
export const dict = {
  ...
  "ui.sessionTurn.status.sending": "Senden",
  ...
  "ui.message.injection.scheduledPrompt": "{{name}} Zeitplan-Task-Prompt",
  "ui.message.injection.scheduledPromptFallback": "Zeitplan-Task injizierter Prompt",
