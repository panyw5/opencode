...
export const dict = {
  ...
  "ui.message.injection.scheduledPrompt": "{{name}} 計劃任務注入提示詞",
  "ui.message.injection.scheduledPromptFallback": "計劃任務注入提示詞",
  "ui.message.injection.projectTaskPrompt": "{{name}} 項目任務注入提示詞",
  "ui.message.injection.projectTaskPromptFallback": "項目任務注入提示詞",
  "ui.message.injection.backgroundTaskCompleted": "後台任務 {{description}} 已完成",
  "ui.message.injection.backgroundTaskCompletedFallback": "後台任務已完成",
  "ui.message.injection.backgroundTaskFailed": "後台任務 {{description}} 失敗",
  "ui.message.injection.backgroundTaskFailedFallback": "後台任務失敗",
  "ui.message.injection.backgroundShellCompleted": "後台 Shell {{description}} 已完成",
  "ui.message.injection.backgroundShellCompletedFallback": "後台 Shell 已完成",
  "ui.message.injection.mathWorkerCompleted": "數學工作智能體已完成",
  "ui.message.injection.mathWorkerBlocked": "數學工作智能體已阻塞",
  "ui.message.injection.mathWorkerEvent": "數學工作智能體事件",
