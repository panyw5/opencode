...
describe("layout workspace helpers", () => {
  ...
  test("normalizes trailing slash in workspace key", () => {
    ...
    expect(workspaceKey("D:\\Apps\\OpenCode")).toBe("d:/apps/opencode")
    expect(workspaceKey("d:/apps/opencode/")).toBe("d:/apps/opencode")
    expect(workspaceKey("\\\\Server\\Share\\Project")).toBe("//server/share/project")
    expect(workspaceKey("/Users/Kelvin/Project")).toBe("/Users/Kelvin/Project")
  })
