export const dict = {
  "scheduled.schedule.every.interval": "Svakih {{count}} min",
  ...
  "settings.tab.goConfig": "Idi na konfiguraciju",
  ...
  "settings.general.section.searchIndex": "Globalna pretraga",
  "settings.general.searchIndex.title": "Globalni indeks",
  "settings.general.searchIndex.description":
    "Indeksira poruke sesija na ovom uređaju kako bi omogućio pretragu svih sesija. Isključivanje briše lokalni indeks bez brisanja sadržaja sesija.",
  "settings.general.searchIndex.status.loading": "Učitavanje statusa indeksa...",
  "settings.general.searchIndex.status.disabled": "Indeks sadržaja sesija je isključen",
  "settings.general.searchIndex.status.unavailable": "Status indeksa sadržaja sesija nije dostupan",
  "settings.general.searchIndex.status.complete": "Indeks sadržaja sesija je završen",
  "settings.general.searchIndex.status.buildingUnknown": "Kreiranje indeksa sadržaja sesija...",
  "settings.general.searchIndex.status.building": "Kreiranje indeksa sadržaja sesija ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Napredak indeksiranja sadržaja sesija",
  "settings.general.searchIndex.action.enable": "Uključi",
  "settings.general.searchIndex.action.disable": "Isključi",
  "settings.general.searchIndex.action.rebuild": "Ponovo izgradi",
