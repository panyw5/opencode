export const dict = {
  ...
  "projectTask.field.descriptionPlaceholder": "Goals, constraints, acceptance criteria…",
  ...
  "projectTask.mount.sectionHint": "Choose a project task for this session. Context injection is off by default.",
  ...
  "projectTask.inject.hint": "When enabled, each LLM turn receives the mounted task description, linked sessions, and open todos. Default is off.",
