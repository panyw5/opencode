export const dict = {
  ...
  "config.channels.header": "Configure IM message channels. Connection will be enabled later.",
  ...
  "config.channels.platform.feishu.detail":
    "Create a Feishu bot app via QR scan, or enter credentials manually. Saved to global opencode.jsonc.",
