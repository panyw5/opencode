export const dict = {
  ...
  "trellis.tasks.autosaving": "Autosaving…",
  "trellis.tasks.autosavePending": "Autosave pending",
  "trellis.tasks.autosaved": "Autosaved",
  ...
  "config.claws.field.codexBinary": "Codex binary",
  "config.claws.field.codexBinaryDescription": "Optional path or command name. Leave empty to use `codex` on PATH.",
  "config.claws.field.codexBinaryPlaceholder": "codex",
  "config.claws.field.codexHome": "CODEX_HOME",
  "config.claws.field.codexHomeDescription": "Optional config home override. Defaults to ~/.codex.",
  "config.claws.field.codexHomePlaceholder": "~/.codex",
  "config.claws.codex.info.title": "Codex install & config.toml",
  "config.claws.codex.info.install": "Install status",
  "config.claws.codex.info.version": "Version",
  "config.claws.codex.info.binary": "Binary path",
  "config.claws.codex.info.model": "Model",
  "config.claws.codex.info.modelProvider": "Model provider",
  "config.claws.codex.info.reasoning": "Reasoning effort",
  "config.claws.codex.info.contextWindow": "Context window",
  "config.claws.codex.info.compactLimit": "Auto-compact limit",
  "config.claws.codex.info.providerName": "Provider name",
  "config.claws.codex.info.providerBaseUrl": "Provider base URL",
  "config.claws.codex.info.wireApi": "Wire API",
  "config.claws.codex.info.sandbox": "Sandbox mode",
  "config.claws.codex.info.approval": "Approval policy",
  "config.claws.codex.info.trustedProjects": "Trusted projects",
  "config.claws.codex.info.configHome": "Config home",
  "config.claws.codex.info.configPath": "config.toml",
  "config.claws.codex.info.configMissing": "missing",
  "config.claws.codex.install.installed": "Installed",
  "config.claws.codex.install.missing": "Not found",
  "config.claws.codex.test.success": "Codex CLI probe succeeded.",
  "config.claws.logs.testingCodex":
    "Probing Codex CLI\nResolving binary and config.toml\nReading model / provider settings...",
  "config.claws.field.claudeBinary": "Claude binary",
  "config.claws.field.claudeBinaryDescription": "Optional path or command name. Leave empty to use `claude` on PATH.",
  "config.claws.field.claudeBinaryPlaceholder": "claude",
  "config.claws.field.claudeHome": "CLAUDE_CONFIG_DIR",
  "config.claws.field.claudeHomeDescription": "Optional config directory override. Defaults to ~/.claude.",
  "config.claws.field.claudeHomePlaceholder": "~/.claude",
  "config.claws.claude.info.title": "Claude install & settings.json",
  "config.claws.claude.info.install": "Install status",
  "config.claws.claude.info.version": "Version",
  "config.claws.claude.info.binary": "Binary path",
  "config.claws.claude.info.model": "Model",
  "config.claws.claude.info.permissionMode": "Permission mode",
  "config.claws.claude.info.defaultMode": "Default mode",
  "config.claws.claude.info.configHome": "Config directory",
  "config.claws.claude.info.settingsPath": "settings.json",
  "config.claws.claude.info.settingsMissing": "missing",
  "config.claws.claude.install.installed": "Installed",
  "config.claws.claude.install.missing": "Not found",
  "config.claws.claude.test.success": "Claude CLI probe succeeded.",
  "config.claws.logs.testingClaude":
    "Probing Claude CLI\nResolving binary and settings.json\nReading model / permission settings...",
