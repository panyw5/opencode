export const dict = {
  ...
  "session.mathSwarm.ensure": "Restart {{title}}",
  "session.mathSwarm.reEnable": "Re-enable {{title}}",
  "session.mathSwarm.stop": "Stop {{title}}",
  "session.mathSwarm.ensured": "Worker restarted",
  "session.mathSwarm.reEnabled": "Worker re-enabled",
  ...
  "session.mathSwarm.reEnable.short": "Re-enable",
