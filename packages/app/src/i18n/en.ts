export const dict = {
  ...
  "home.quickAdd.description": "Type a local folder path. Suggestions appear as you type.",
  ...
  "home.quickAdd.hint.complete": "↑↓ navigate · Tab complete",
  "home.quickAdd.hint.add": "Enter open project",
  ...
  "config.provider.disabled":
    "This provider is disabled. Login data is preserved. Enable it to restore connection.",
