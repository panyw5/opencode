export const dict = {
  ...
  "sidebar.im.toast.opened.model": "Model: {{model}}. Opened as its own session list.",
  "sidebar.im.toast.opened.runtime": "No model set (using default). Opened as its own session list.",
