export const dict = {
  ...
  "scheduled.prompt.description": "Write the Markdown prompt the Agent should run on schedule.",
  ...
  "scheduled.execution.existing": "Continue an existing session",
  ...
  "config.claws.note.codex": "Local Codex CLI used as a read-only external advisor (codex_consult).",
