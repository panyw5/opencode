...
export const dict = {
  "scheduled.schedule.every.interval": "Alle {{count}} Min.",
  ...
  "command.session.recent": "Letzte Sitzungen",
  "command.session.recent.description": "Die 20 zuletzt aktiven Sitzungen in diesem Projekt öffnen",
  "session.recent.placeholder": "Letzte Sitzungen durchsuchen...",
  "session.recent.empty": "Keine letzten Sitzungen",
  ...
  "context.stats.limitReferencedLabel": "Kontextlimit (referenced from {{source}})",
  ...
  "settings.tab.goConfig": "Zur Konfiguration",
  ...
  "settings.general.section.searchIndex": "Globale Suche",
  "settings.general.searchIndex.title": "Globaler Index",
  "settings.general.searchIndex.description":
    "Indiziert Sitzungsnachrichten auf diesem Gerät, damit Sie alle Sitzungen durchsuchen können. Beim Deaktivieren wird der lokale Index gelöscht, nicht aber der Sitzungsinhalt.",
  "settings.general.searchIndex.status.loading": "Indexstatus wird geladen...",
  "settings.general.searchIndex.status.disabled": "Der Sitzungsinhaltsindex ist deaktiviert",
  "settings.general.searchIndex.status.unavailable": "Der Status des Sitzungsinhaltsindex ist nicht verfügbar",
  "settings.general.searchIndex.status.complete": "Sitzungsinhaltsindex vollständig",
  "settings.general.searchIndex.status.buildingUnknown": "Sitzungsinhaltsindex wird erstellt...",
  "settings.general.searchIndex.status.building": "Sitzungsinhaltsindex wird erstellt ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Fortschritt der Sitzungsinhaltsindizierung",
  "settings.general.searchIndex.action.enable": "Aktivieren",
  "settings.general.searchIndex.action.disable": "Deaktivieren",
  "settings.general.searchIndex.action.rebuild": "Neu erstellen",
