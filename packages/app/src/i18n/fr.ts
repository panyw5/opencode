export const dict = {
  "scheduled.schedule.every.interval": "Toutes les {{count}} min",
  ...
  "command.session.recent": "Sessions récentes",
  "command.session.recent.description": "Ouvrir les 20 sessions les plus actives récemment dans ce projet",
  "session.recent.placeholder": "Rechercher des sessions récentes...",
  "session.recent.empty": "Aucune session récente",
  ...
  "context.stats.limitReferencedLabel": "Limite de contexte (referenced from {{source}})",
  ...
  "session.todo.mounted": "Tâche de projet liée",
  ...
  "settings.tab.goConfig": "Aller à la configuration",
  ...
  "settings.general.section.searchIndex": "Recherche globale",
  "settings.general.searchIndex.title": "Index global",
  "settings.general.searchIndex.description":
    "Indexe les messages des sessions sur cet appareil afin de rechercher dans toutes les sessions. La désactivation efface l'index local sans supprimer le contenu des sessions.",
  "settings.general.searchIndex.status.loading": "Chargement de l'état de l'index...",
  "settings.general.searchIndex.status.disabled": "L'index du contenu des sessions est désactivé",
  "settings.general.searchIndex.status.unavailable": "L'état de l'index du contenu des sessions est indisponible",
  "settings.general.searchIndex.status.complete": "Index du contenu des sessions terminé",
  "settings.general.searchIndex.status.buildingUnknown": "Création de l'index du contenu des sessions...",
  "settings.general.searchIndex.status.building":
    "Création de l'index du contenu des sessions ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Progression de l'indexation du contenu des sessions",
  "settings.general.searchIndex.action.enable": "Activer",
  "settings.general.searchIndex.action.disable": "Désactiver",
  "settings.general.searchIndex.action.rebuild": "Reconstruire",
