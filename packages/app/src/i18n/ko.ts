...
export const dict = {
  "scheduled.schedule.every.interval": "{{count}}분마다",
  ...
  "command.session.recent": "최근 세션",
  "command.session.recent.description": "이 프로젝트에서 최근 활성 세션 20개 열기",
  "session.recent.placeholder": "최근 세션 검색...",
  "session.recent.empty": "최근 세션이 없습니다",
  ...
  "settings.general.section.searchIndex": "전역 검색 기능",
  "settings.general.searchIndex.title": "전역 인덱스",
  "settings.general.searchIndex.description":
    "모든 세션을 검색할 수 있도록 이 기기에서 세션 메시지를 인덱싱합니다. 비활성화하면 세션 내용은 삭제하지 않고 로컬 인덱스만 지웁니다.",
  "settings.general.searchIndex.status.loading": "인덱스 상태를 불러오는 중...",
  "settings.general.searchIndex.status.disabled": "세션 내용 인덱스가 비활성화되어 있습니다",
  "settings.general.searchIndex.status.unavailable": "세션 내용 인덱스 상태를 확인할 수 없습니다",
  "settings.general.searchIndex.status.complete": "세션 내용 인덱스 완료",
  "settings.general.searchIndex.status.buildingUnknown": "세션 내용 인덱스를 생성하는 중...",
  "settings.general.searchIndex.status.building": "세션 내용 인덱스 생성 중 ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "세션 내용 인덱싱 진행률",
  "settings.general.searchIndex.action.enable": "활성화",
  "settings.general.searchIndex.action.disable": "비활성화",
  "settings.general.searchIndex.action.rebuild": "다시 생성",
