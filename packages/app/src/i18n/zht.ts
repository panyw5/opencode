...
export const dict = {
  ...
  "command.terminal.toggle": "終端機",
  "command.fileTree.toggle": "檔案樹",
  "command.review.toggle": "審查",
  ...
  "provider.custom.models.config.fillPreset": "填入預設",
  "provider.custom.models.config.noPreset": "此欄位暫無明確匹配的預設",
  "provider.custom.models.config.presetFailed": "模型目錄暫時無法使用",
  ...
  "common.save": "儲存",
  "common.saving": "儲存中...",
  "config.agents.group.builtin": "內建",
  "config.agents.group.global": "全域",
  "config.agents.group.jsonc": "opencode.jsonc",
  "config.agents.jsonc.description": "來自全域 JSONC 檔案的代理程式設定。",
  "config.agents.jsonc.listNote": "全域 JSONC 設定",
  "config.agents.jsonc.saving": "正在儲存",
  "config.agents.field.model": "模型",
  "config.agents.field.variant": "變體",
  "config.agents.field.temperature": "溫度",
  "config.agents.field.topP": "Top P",
  "config.agents.field.color": "顏色",
  "config.agents.field.steps": "步數",
  "config.agents.field.description": "說明",
  "config.agents.field.mode": "模式",
  "config.agents.field.default": "預設",
  "config.agents.field.hidden": "隱藏",
  "config.agents.field.disabled": "停用",
  ...
  "context.stats.totalTokens": "目前上下文 token",
  ...
  "settings.general.row.iconPack.title": "圖示包",
  "settings.general.row.iconPack.description": "選擇應用全域使用的圖示風格",
