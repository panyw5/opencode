export const dict = {
  "scheduled.schedule.every.interval": "Co {{count}} min",
  ...
  "command.session.recent": "Ostatnie sesje",
  "command.session.recent.description": "Otwórz 20 ostatnio aktywnych sesji w tym projekcie",
  "session.recent.placeholder": "Szukaj ostatnich sesji...",
  "session.recent.empty": "Brak ostatnich sesji",
  ...
  "context.stats.limitReferencedLabel": "Limit kontekstu (referenced from {{source}})",
  ...
  "session.todo.mounted": "Powiązano zadanie projektu",
  ...
  "settings.tab.goConfig": "Przejdź do konfiguracji",
  ...
  "settings.general.section.searchIndex": "Wyszukiwanie globalne",
  "settings.general.searchIndex.title": "Indeks globalny",
  "settings.general.searchIndex.description":
    "Indeksuje wiadomości sesji na tym urządzeniu, aby umożliwić wyszukiwanie we wszystkich sesjach. Wyłączenie usuwa lokalny indeks, ale nie zawartość sesji.",
  "settings.general.searchIndex.status.loading": "Wczytywanie stanu indeksu...",
  "settings.general.searchIndex.status.disabled": "Indeks zawartości sesji jest wyłączony",
  "settings.general.searchIndex.status.unavailable": "Stan indeksu zawartości sesji jest niedostępny",
  "settings.general.searchIndex.status.complete": "Indeks zawartości sesji jest gotowy",
  "settings.general.searchIndex.status.buildingUnknown": "Tworzenie indeksu zawartości sesji...",
  "settings.general.searchIndex.status.building": "Tworzenie indeksu zawartości sesji ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Postęp indeksowania zawartości sesji",
  "settings.general.searchIndex.action.enable": "Włącz",
  "settings.general.searchIndex.action.disable": "Wyłącz",
  "settings.general.searchIndex.action.rebuild": "Przebuduj",
