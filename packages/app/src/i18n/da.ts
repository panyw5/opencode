export const dict = {
  ...
  "command.session.recent": "Seneste sessioner",
  "command.session.recent.description": "Åbn de 20 senest aktive sessioner i dette projekt",
  "session.recent.placeholder": "Søg i seneste sessioner...",
  "session.recent.empty": "Ingen seneste sessioner",
  ...
  "settings.tab.goConfig": "Gå til konfiguration",
  ...
  "settings.general.section.searchIndex": "Global søgning",
  "settings.general.searchIndex.title": "Globalt indeks",
  "settings.general.searchIndex.description":
    "Indekser sessionsbeskeder på denne enhed, så du kan søge på tværs af alle sessioner. Deaktivering rydder det lokale indeks uden at slette sessionsindhold.",
  "settings.general.searchIndex.status.loading": "Indlæser indeksstatus...",
  "settings.general.searchIndex.status.disabled": "Indekset over sessionsindhold er deaktiveret",
  "settings.general.searchIndex.status.unavailable": "Status for indekset over sessionsindhold er ikke tilgængelig",
  "settings.general.searchIndex.status.complete": "Indekset over sessionsindhold er færdigt",
  "settings.general.searchIndex.status.buildingUnknown": "Opretter indeks over sessionsindhold...",
  "settings.general.searchIndex.status.building": "Opretter indeks over sessionsindhold ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Indekseringsstatus for sessionsindhold",
  "settings.general.searchIndex.action.enable": "Aktiver",
  "settings.general.searchIndex.action.disable": "Deaktiver",
  "settings.general.searchIndex.action.rebuild": "Genopbyg",
