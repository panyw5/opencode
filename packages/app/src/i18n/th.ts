export const dict = {
  "scheduled.schedule.every.interval": "ทุก {{count}} นาที",
  ...
  "settings.general.section.searchIndex": "การค้นหาทั่วโลก",
  "settings.general.searchIndex.title": "ดัชนีทั่วโลก",
  "settings.general.searchIndex.description":
    "จัดทำดัชนีข้อความเซสชันบนอุปกรณ์นี้เพื่อค้นหาในทุกเซสชัน การปิดใช้งานจะล้างดัชนีในเครื่องโดยไม่ลบเนื้อหาเซสชัน",
  "settings.general.searchIndex.status.loading": "กำลังโหลดสถานะดัชนี...",
  "settings.general.searchIndex.status.disabled": "ดัชนีเนื้อหาเซสชันถูกปิดใช้งาน",
  "settings.general.searchIndex.status.unavailable": "ไม่สามารถดูสถานะดัชนีเนื้อหาเซสชันได้",
  "settings.general.searchIndex.status.complete": "จัดทำดัชนีเนื้อหาเซสชันเสร็จแล้ว",
  "settings.general.searchIndex.status.buildingUnknown": "กำลังสร้างดัชนีเนื้อหาเซสชัน...",
  "settings.general.searchIndex.status.building": "กำลังสร้างดัชนีเนื้อหาเซสชัน ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "ความคืบหน้าการจัดทำดัชนีเนื้อหาเซสชัน",
  "settings.general.searchIndex.action.enable": "เปิดใช้งาน",
  "settings.general.searchIndex.action.disable": "ปิดใช้งาน",
  "settings.general.searchIndex.action.rebuild": "สร้างใหม่",
