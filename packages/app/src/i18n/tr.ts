...
export const dict = {
  "scheduled.schedule.every.interval": "Her {{count}} dk",
  ...
  "settings.tab.goConfig": "Yapılandırmaya git",
  ...
  "settings.general.section.searchIndex": "Genel arama",
  "settings.general.searchIndex.title": "Genel indeks",
  "settings.general.searchIndex.description":
    "Tüm oturumlarda arama yapabilmeniz için oturum mesajlarını bu cihazda indeksler. Devre dışı bırakmak oturum içeriğini silmeden yerel indeksi temizler.",
  "settings.general.searchIndex.status.loading": "İndeks durumu yükleniyor...",
  "settings.general.searchIndex.status.disabled": "Oturum içeriği indeksi devre dışı",
  "settings.general.searchIndex.status.unavailable": "Oturum içeriği indeksinin durumu kullanılamıyor",
  "settings.general.searchIndex.status.complete": "Oturum içeriği indeksi tamamlandı",
  "settings.general.searchIndex.status.buildingUnknown": "Oturum içeriği indeksi oluşturuluyor...",
  "settings.general.searchIndex.status.building": "Oturum içeriği indeksi oluşturuluyor ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Oturum içeriği indeksleme ilerlemesi",
  "settings.general.searchIndex.action.enable": "Etkinleştir",
  "settings.general.searchIndex.action.disable": "Devre dışı bırak",
  "settings.general.searchIndex.action.rebuild": "Yeniden oluştur",
