export const dict = {
  "scheduled.schedule.every.interval": "Каждые {{count}} мин",
  ...
  "command.session.recent": "Недавние сессии",
  "command.session.recent.description": "Открыть 20 последних активных сессий в этом проекте",
  "session.recent.placeholder": "Поиск недавних сессий...",
  "session.recent.empty": "Нет недавних сессий",
  ...
  "context.stats.limitReferencedLabel": "Лимит контекста (referenced from {{source}})",
  ...
  "settings.tab.goConfig": "Перейти к конфигурации",
  ...
  "settings.general.section.searchIndex": "Глобальный поиск",
  "settings.general.searchIndex.title": "Глобальный индекс",
  "settings.general.searchIndex.description":
    "Индексирует сообщения сеансов на этом устройстве для поиска по всем сеансам. При отключении локальный индекс очищается, но содержимое сеансов не удаляется.",
  "settings.general.searchIndex.status.loading": "Загрузка состояния индекса...",
  "settings.general.searchIndex.status.disabled": "Индекс содержимого сеансов отключён",
  "settings.general.searchIndex.status.unavailable": "Состояние индекса содержимого сеансов недоступно",
  "settings.general.searchIndex.status.complete": "Индекс содержимого сеансов готов",
  "settings.general.searchIndex.status.buildingUnknown": "Создание индекса содержимого сеансов...",
  "settings.general.searchIndex.status.building": "Создание индекса содержимого сеансов ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Ход индексации содержимого сеансов",
  "settings.general.searchIndex.action.enable": "Включить",
  "settings.general.searchIndex.action.disable": "Отключить",
  "settings.general.searchIndex.action.rebuild": "Перестроить",
