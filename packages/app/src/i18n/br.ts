export const dict = {
  "scheduled.schedule.every.interval": "A cada {{count}} min",
  ...
  "command.config.open": "Abrir configuração",
  ...
  "command.session.recent": "Sessões recentes",
  "command.session.recent.description": "Abrir as 20 sessões mais ativas recentemente neste projeto",
  "session.recent.placeholder": "Buscar sessões recentes...",
  "session.recent.empty": "Nenhuma sessão recente",
  ...
  "context.stats.limitReferencedLabel": "Limite de Contexto (referenced from {{source}})",
  ...
  "settings.tab.goConfig": "Ir para configuração",
  ...
  "settings.general.section.searchIndex": "Pesquisa global",
  "settings.general.searchIndex.title": "Índice global",
  "settings.general.searchIndex.description":
    "Indexa as mensagens das sessões neste dispositivo para pesquisar em todas as sessões. Desativar limpa o índice local sem excluir o conteúdo das sessões.",
  "settings.general.searchIndex.status.loading": "Carregando o status do índice...",
  "settings.general.searchIndex.status.disabled": "O índice de conteúdo das sessões está desativado",
  "settings.general.searchIndex.status.unavailable": "O status do índice de conteúdo das sessões não está disponível",
  "settings.general.searchIndex.status.complete": "Índice de conteúdo das sessões concluído",
  "settings.general.searchIndex.status.buildingUnknown": "Criando o índice de conteúdo das sessões...",
  "settings.general.searchIndex.status.building": "Criando o índice de conteúdo das sessões ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Progresso da indexação do conteúdo das sessões",
  "settings.general.searchIndex.action.enable": "Ativar",
  "settings.general.searchIndex.action.disable": "Desativar",
