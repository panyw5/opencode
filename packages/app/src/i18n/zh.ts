...
export const dict = {
  "projectTask.title": "项目任务",
  "projectTask.subtitle": "项目级工作，关联会话待办",
  "projectTask.back": "返回会话列表",
  "projectTask.refresh": "刷新项目任务",
  ...
  "scheduled.subtitle": "OpenCode 服务运行时自动执行的无人值守 Agent 提示词。",
  ...
  "scheduled.select": "选择一个任务，或新建任务。",
  "scheduled.filter.all": "所有项目",
  "scheduled.project": "项目",
  "scheduled.name": "名称",
  "scheduled.prompt": "任务提示词",
  "scheduled.prompt.placeholder": "描述这个任务需要定时完成的工作...",
  "scheduled.section.basics": "任务设置",
  "scheduled.section.timing": "计划与会话",
  "scheduled.agent": "Agent",
  "scheduled.provider": "Provider ID",
  "scheduled.model": "模型",
  "scheduled.modelID": "Model ID",
  "scheduled.variant": "Variant",
  "scheduled.execution": "会话模式",
  "scheduled.execution.automatic": "复用并自动轮换（30 轮或上下文达到 100 万 token）",
  ...
  "scheduled.cron": "五段 Cron",
  "scheduled.cron.meaning": "含义",
  "scheduled.timezone": "时区",
  "scheduled.enabled": "已启用",
  "scheduled.disabled": "已停用",
  "scheduled.enable": "启用任务",
  "scheduled.disable": "停用任务",
  "scheduled.nextRun": "下次运行",
  "scheduled.lastRun": "最近运行",
  "scheduled.lastStatus": "最近状态",
  ...
  "provider.custom.models.config.fillPreset": "填入预设",
  "provider.custom.models.config.noPreset": "此字段暂无明确匹配的预设",
  "provider.custom.models.config.presetFailed": "模型目录暂时不可用",
  ...
  "provider.disconnect.toast.removing": "移除 {{provider}} 中，请稍后",
  ...
  "prompt.suggestion.hint.sendKeepView": "输入提示词后，将鼠标悬停在发送按钮上，会出现“发送并保持视野”按钮。",
  "prompt.suggestion.hint.tempAttachment": "很长的提示词可以用“附加临时文件”，避免输入被截断。",
  "prompt.suggestion.hint.expandEditor": "点击下方的“展开编辑器”按钮，输入提示词更轻松。",
  "prompt.suggestion.hint.sessionTabMenu": "会话标签也可以右键点击打开菜单。",
  "prompt.suggestion.hint.sessionListMenu": "会话列表中的每条会话标题也可以右键点击打开菜单。",
  "prompt.suggestion.hint.newSessionProjectPicker":
    "在主页使用“新建会话”快捷键，可以打开项目选单，快速在任意项目中新建会话。",
  "prompt.suggestion.hint.externalAgents": "在设置页启用外部智能体，就可以 @ 它直接下达命令。",
  "prompt.suggestion.hint.dragDrop": "把图片、PDF 或文本文件拖到这里，就能作为上下文附件。",
  "prompt.suggestion.hint.mentions": "输入 @ 可以提及文件、参谋或智能体；输入 / 可以运行命令或技能。",
  "prompt.suggestion.hint.stopAfterTool": "任务运行时，将鼠标悬停在停止按钮上，可以选择“当前工具完成后停止”。",
  ...
  "prompt.suggestion.hint.dropFolder": "把文件夹拖到窗口中，就能直接打开为项目。",
  "prompt.suggestion.hint.reorderProjects": "拖拽侧边栏中的项目图标，可以按你的习惯重新排序。",
  "prompt.suggestion.hint.questionPanel": "Question 问题面板支持键盘操作、折叠展开和粘贴图片。",
  "prompt.suggestion.hint.sessionStatus": "打开“会话状态”浮窗，可以查看并复制文件变更和会话详情。",
  "prompt.suggestion.hint.projectTasks": "用“项目任务”跨会话跟踪工作，用“会话任务”查看当前会话的 Todo。",
  "prompt.suggestion.hint.search": "使用“页面查找”或“全局查找”搜索内容；全局查找需要先启用索引。",
  "prompt.suggestion.hint.filePaths":
    "点击文件路径可以预览；按住 Cmd/Ctrl 再点击，可以用编辑器或文件管理器打开。",
  "prompt.suggestion.hint.readingMode": "开启“阅读模式”，可以隐藏干扰，专注查看会话内容。",
  "prompt.suggestion.hint.configHub":
    "配置页可以集中管理提供商、智能体、技能、命令、插件和 MCP 服务。",
  ...
  "dialog.directory.remote.invalid": "远程主机上未找到该目录",
  ...
  "dialog.server.addSsh.title": "添加 SSH 服务器",
  "dialog.server.addSsh.target": "SSH 目标",
  "dialog.server.addSsh.targetPlaceholder": "user@host、host:2222 或 ~/.ssh/config 别名",
  "dialog.server.addSsh.hint": "使用本机 SSH 密钥、agent 和 ~/.ssh/config 配置连接，不支持密码登录。",
  "dialog.server.addSsh.error": "请输入有效的 SSH 目标（不含空格）",
  "dialog.server.ssh.section": "SSH 服务器",
  "dialog.server.ssh.empty": "尚未配置 SSH 服务器",
  "dialog.server.ssh.start": "启动",
  "dialog.server.ssh.restart": "重启",
  "dialog.server.ssh.installOpencode": "安装 opencode",
  "dialog.server.ssh.remove": "移除",
  "dialog.server.ssh.status.starting": "启动中…",
  "dialog.server.ssh.status.ready": "运行中",
  "dialog.server.ssh.status.failed": "失败",
  "dialog.server.ssh.status.stopped": "已停止",
  "dialog.server.ssh.actionFailed": "SSH 操作失败",
  ...
  "context.stats.totalTokens": "当前上下文 token",
  ...
  "home.quickAdd.placeholder": "~/projects/my-app",
  "home.quickAdd.add": "打开项目",
  "home.quickAdd.browse": "浏览并选择项目",
  "home.quickAdd.invalid": "找不到该文件夹，请检查路径后重试。",
  "home.quickAdd.noMatches": "没有匹配的文件夹",
  ...
  "home.recentSessions.status.permission": "需要权限",
  "home.recentSessions.status.question": "有提问待回答",
  ...
  "home.upcomingTasks.status.scheduled": "已安排",
  "home.upcomingTasks.status.ready": "就绪",
  "home.upcomingTasks.status.running": "运行中",
  "home.upcomingTasks.status.error": "需要处理",

  "session.tab.session": "会话",
  "session.tab.review": "审查",
  "session.tab.context": "上下文",
  "session.tabs.bar.label": "会话标签页",
  ...
  "session.mathSwarm.button": "证明群（{{count}}）",
  "session.mathSwarm.open": "打开数学模式证明群",
  "session.mathSwarm.label": "工人智能体",
  "session.mathSwarm.round": "第 {{round}} 轮",
  "session.mathSwarm.ensure": "继续 {{title}} 工作",
  "session.mathSwarm.reEnable": "继续 {{title}} 工作",
  "session.mathSwarm.stop": "停止 {{title}}",
  "session.mathSwarm.ensured": "工人已继续工作",
  "session.mathSwarm.reEnabled": "工人已继续工作",
  "session.mathSwarm.stopped": "已发送停止信号",
  "session.mathSwarm.state.running": "运行中",
  "session.mathSwarm.state.stopping": "停止中",
  "session.mathSwarm.state.dead": "已停止",
  "session.mathSwarm.state.interrupted": "意外中止",
  ...
  "session.mathSwarm.restart": "继续工作",
  ...
  "session.mathSwarm.details.proof": "证明",
  "session.mathSwarm.details.intuition": "直觉说明",
  "session.mathSwarm.details.evidence": "验证依据",
  "session.mathSwarm.details.report": "验证报告",
  "session.mathSwarm.details.criticalErrors": "关键错误",
  "session.mathSwarm.details.gaps": "证明缺口",
  "session.mathSwarm.details.predecessors": "前置事实",
  "session.mathSwarm.details.proofUnavailable": "这条验证记录没有保存提交的完整证明。",
  "session.mathSwarm.details.openWorker": "打开工人会话",
  "session.mathSwarm.details.previous": "上一页",
  "session.mathSwarm.details.next": "下一页",
  "session.mathSwarm.details.range": "第 {{start}}–{{end}} 条，共 {{total}} 条",
  ...
  "session.mathSwarm.elapsed": "已运行 {{elapsed}}",
  "session.mathSwarm.tokens": "{{tokens}} tokens",
  "session.mathSwarm.cost": "${{cost}}",
  "session.mathSwarm.task": "调整任务",
  "session.mathSwarm.copyMeta": "复制工人 meta",
  "session.mathSwarm.copyMeta.copied": "已复制工人 meta",
  "session.mathSwarm.copyMeta.failed": "无法复制工人 meta",
  "session.mathInitialize.button": "数学模式",
  "session.mathInitialize.open": "初始化数学模式",
  ...
  "session.mathInitialize.project.error": "请输入有效的问题级项目名称。",
  "session.mathInitialize.problem": "研究问题",
  "session.mathInitialize.problem.description": "写明问题、假设、研究范围和完成判据。",
  "session.mathInitialize.model": "工人模型",
  "session.mathInitialize.model.description": "新证据工人使用的 provider/model。",
  "session.mathInitialize.verifierModel": "验证器模型",
  "session.mathInitialize.verifierModel.description":
    "独立审核每条提交证明的 provider/model。之后仍可在 Math Mode 面板中更改。",
  "session.mathSwarm.verifierModel": "验证器模型",
  "session.mathSwarm.verifierModel.description": "立即应用于此项目的下一次证明验证。",
  "session.mathSwarm.verifierModel.saved": "验证器模型已更新",
  "session.mathSwarm.verifierModel.save": "应用",
  "session.mathInitialize.highWorkers": "高强度工人",
  "session.mathInitialize.xhighWorkers": "超高强度工人",
  "session.mathInitialize.workers.decrease": "减少",
  "session.mathInitialize.workers.increase": "增加",
  "session.mathInitialize.controlBeat": "创建 30 分钟控制心跳",
  ...
  "session.mathInitialize.initializing": "初始化中...",
  "session.mathTask.title": "调整数学工人任务",
  "session.mathTask.description": "将原子替换 durable TASK；运行中的工人会在下一轮开始时读取，不会打断当前推理。",
  "session.mathTask.body": "工人 TASK",
  "session.mathTask.save": "保存到下一轮",
  "session.mathTask.updated": "工人任务已更新",
  ...
  "session.status.files.deleted": "删除的文件",
  "session.status.expand": "展开会话状态",
  "session.status.collapse": "收起会话状态",
  "session.status.empty": "本会话尚未激活任何技能。",
  "session.status.contextUsage": "上下文用量",
  "session.status.files.viewAll": "查看全部",
  ...
  "sidebar.settings": "设置",
  "sidebar.panels.stashed": "已收纳的浮窗",
  "sidebar.panels.minimize": "最小化",
  "sidebar.panels.stashedEditorScheduled": "定时任务编辑",
  "sidebar.panels.stashedEditorProject": "项目任务详情",
  ...
  "settings.general.row.iconPack.title": "图标包",
  "settings.general.row.iconPack.description": "选择应用全局使用的图标风格",
  "settings.general.row.iconPack.option.phosphor": "Phosphor",
  "settings.general.row.iconPack.option.lucide": "Lucide",
  "settings.general.row.iconPack.option.tabler": "Tabler",
  "settings.general.row.iconPack.option.legacy": "Legacy",
  ...
  "settings.general.row.sessionTabsBar.title": "会话标签页",
  "settings.general.row.sessionTabsBar.description": "在窗口顶部以标签页形式显示打开的会话",
  "settings.general.row.mathMode.title": "数学模式",
  "settings.general.row.mathMode.description": "启用数学模式集群。禁用后将隐藏相关技能、命令与界面入口",
  "settings.general.mathMode.toast.enabled": "数学模式已启用",
  "settings.general.mathMode.toast.disabled": "数学模式已禁用",
  "settings.general.mathMode.toast.failed": "更新数学模式设置失败",
  ...
  "settings.providers.commandcode.note": "使用 Command Code 登录并访问其模型目录",
  ...
  "config.nav.pluginsDescription": "管理插件，编辑脚本",
  "config.nav.mcpDescription": "管理编辑 MCP 服务器",
  "config.nav.commandsDescription": "管理编辑斜杠命令",
  "config.nav.channelsDescription": "配置即时通讯渠道",
  "config.nav.imDescription": "渠道固定接收人和项目监听",
  "config.nav.clawsDescription": "Hermes、Codex 等",
  "config.common.and": " 和 ",
  ...
  "agentsMd.dialog.placeholder": "# 项目 AGENTS.md\n\n在此编写项目专属指令...",
  "agentsMd.dialog.empty": "暂无内容可预览。",
  "agentsMd.dialog.notExists": "文件尚不存在，保存即可创建。",
  "common.refresh": "刷新",
  "common.unsavedChanges": "有未保存的更改",
  "sidebar.project.agentsMd": "AGENTS.md",
  ...
  "config.agents.meta.permissions": "权限",
  "config.agents.meta.permissions.empty": "frontmatter 中没有权限。",
  "config.agents.meta.permissions.all": "全部工具",
  "config.agents.meta.permissions.unknown": "未知权限键",
  "config.agents.meta.permissions.unknownTool": "未知工具 {{name}}",
  "config.agents.meta.permissions.invalid": "无效权限动作",
  "config.agents.meta.permissions.default": "默认",
  "config.agents.meta.permissions.builtinDefault": "内置默认值，点击可覆盖。",
  "config.agents.meta.permissions.patternLocked": "该权限包含模式规则，请直接编辑 opencode.jsonc 修改。",
  "config.agents.meta.permissions.other": "其他内置权限",
  "config.agents.builtin.description": "内置智能体，修改会写入全局 opencode.jsonc 的 agent 配置。",
  "config.agents.builtin.overridden": "已通过 opencode.jsonc 覆盖",
  "config.agents.builtin.permissionsHint": "点击胶囊可切换：允许 → 询问 → 拒绝 → 内置默认。",
  "config.agents.builtin.prompt.empty": "没有自定义提示词，该智能体使用内置默认系统提示词。",
  ...
  "config.claws.cliAgent.binary": "{{label}} 可执行文件",
  "config.claws.cliAgent.binaryDescription": "可选路径或命令名。留空则使用 PATH 上的 `{{command}}`。",
  "config.claws.cliAgent.configHomeDescription": "可选配置主目录覆盖。",
  "config.claws.info.installStatus": "安装状态",
  "config.claws.info.version": "版本",
  "config.claws.info.binaryPath": "可执行文件路径",
  "config.claws.info.configPath": "配置路径",
  "config.claws.dsh.title": "DeepSeek Harness（~/.dsh）",
  "config.claws.dsh.description":
    "将供应商/模型/Base URL 写入 settings.yaml，可选 API Key 写入 .credentials.yaml。不会常驻后台进程。",
  "config.claws.dsh.field.provider": "供应商",
  "config.claws.dsh.field.providerDescription": "dsh 供应商路由 id（默认 deepseek-official）",
  "config.claws.dsh.field.model": "模型",
  "config.claws.dsh.field.modelDescription": "供应商侧模型 id（例如 deepseek-v4-flash）",
  "config.claws.dsh.field.baseURL": "Base URL",
  "config.claws.dsh.field.baseURLDescription":
    "可选。写入 llm-deepseek.baseURL（默认 https://api.deepseek.com）。留空则清除覆盖。",
  "config.claws.dsh.field.baseURLDescriptionEnv":
    "写入 settings.yaml 中的 llm-deepseek.baseURL。本机还设置了 DEEPSEEK_BASE_URL 环境变量。",
  "config.claws.dsh.field.baseURLPlaceholder": "https://api.deepseek.com",
  "config.claws.dsh.field.apiKey": "API Key",
  "config.claws.dsh.field.apiKeyDescription": "状态：{{status}}。留空则保留已有文件密钥。",
  "config.claws.dsh.field.apiKeyPlaceholder": "sk-...",
  "config.claws.dsh.field.apiKeyPlaceholderKeep": "••••••••（留空保留）",
  "config.claws.dsh.field.apiKeyShow": "显示 API Key",
  "config.claws.dsh.field.apiKeyHide": "隐藏 API Key",
  "config.claws.dsh.field.apiKeyCopy": "复制 API Key",
  "config.claws.dsh.field.clearApiKey": "清除 ~/.dsh/.credentials.yaml 中已存储的 API Key",
  "config.claws.dsh.apiKeyStatus.willClear": "保存后将清除文件密钥",
  "config.claws.dsh.apiKeyStatus.willWrite": "保存后将写入新密钥",
  "config.claws.dsh.apiKeyStatus.fileAndEnv": "文件密钥 + DEEPSEEK_API_KEY 环境变量",
  "config.claws.dsh.apiKeyStatus.file": "已有文件密钥",
  "config.claws.dsh.apiKeyStatus.env": "已设置 DEEPSEEK_API_KEY 环境变量",
  "config.claws.dsh.apiKeyStatus.none": "未配置 API Key",
  "config.claws.dsh.plugins.title": "生效插件",
  "config.claws.dsh.plugins.description":
    "通过 `dsh --profile headless --dump-config` 读取组合后的插件树。点击行可展开查看 config。",
  "config.claws.dsh.plugins.load": "加载插件列表",
  "config.claws.dsh.plugins.loading": "加载中…",
  "config.claws.dsh.plugins.hint": "点击「加载插件列表」以 dump 当前 dsh 组合。",
  "config.claws.dsh.plugins.summary":
    "共 {{total}} 个插件 · {{enabled}} 启用 · {{disabled}} 禁用 · profile {{profile}}",
  "config.claws.dsh.plugins.sources": "来源：{{sources}}",
  "config.claws.dsh.plugins.search": "筛选",
  "config.claws.dsh.plugins.searchDescription": "按插件 id、包名、来源或 config 文本匹配。",
  "config.claws.dsh.plugins.searchPlaceholder": "例如 tool-bash、llm、headless",
  "config.claws.dsh.plugins.showDisabled": "显示已禁用",
  "config.claws.dsh.plugins.empty": "没有匹配当前筛选的插件。",
  "config.claws.dsh.plugins.unnamed": "（无包名）",
  "config.claws.dsh.plugins.source": "来源：{{source}}",
  "config.claws.dsh.plugins.config": "配置",
  "config.claws.dsh.plugins.noConfig": "（无 config 覆盖）",
  "config.claws.dsh.plugins.badge.disabled": "已禁用",
  "config.claws.dsh.plugins.badge.conditional": "条件禁用",
  "config.claws.dsh.plugins.badge.enabled": "已启用",
  "config.claws.dsh.plugins.enable": "启用",
  "config.claws.dsh.plugins.disable": "禁用",
  "config.claws.dsh.plugins.toggling": "…",
  "config.claws.dsh.plugins.conditionalHint": "该插件由表达式条件禁用，无法在此切换。",
  "config.claws.dsh.plugins.enabledToast": "插件已启用",
  "config.claws.dsh.plugins.disabledToast": "插件已禁用",
  ...
  "config.channels.header": "配置 IM 通道和机器人运行设置。",
  ...
  "config.channels.platform.feishu.detail": "通过扫码创建飞书智能体应用，或手动填写凭证。保存到 OpenCode 通道配置。",
  ...
  "config.channels.platform.wechat": "微信",
  "config.channels.platform.wechat.note": "通过官方 ClawBot 扫码授权连接",
  "config.channels.platform.wechat.detail": "绑定微信 ClawBot，支持私聊文本和入站媒体。暂不支持群聊与出站媒体。",
  "config.channels.wechat.hint": "使用微信扫码授权此渠道。凭据仅保存在本机私密存储中，主动通知可能受平台限制。",
  "config.channels.wechat.createHint": "先创建渠道，再展开该渠道扫码绑定微信账号。",
  "config.channels.wechat.account": "已绑定账号",
  "config.channels.wechat.aclHint": "允许的发送者 ID，每行一个。留空默认仅允许扫码授权用户。",
  "config.channels.wechat.bind": "扫码绑定",
  "config.channels.wechat.rebind": "刷新二维码 / 重新绑定",
  "config.channels.wechat.check": "查看连接状态",
  "config.channels.wechat.qrAlt": "微信授权二维码",
  "config.channels.wechat.status": "授权状态",
  "config.channels.wechat.verify": "微信中显示的验证码",
  "config.channels.wechat.alreadyBound":
    "平台报告机器人已绑定。请检查已保存账号或重新授权；该响应本身不能证明连接已完成。",
  "config.channels.wechat.connection": "连接状态（不代表消息发送测试）",
  "config.channels.wechat.networkError": "授权请求失败，请检查后端连接或刷新二维码。",
  "config.channels.platform.qq.note": "通过 QQ 开放平台连接",
  "config.channels.platform.qq.detail": "通过 QQ 开放平台 AppID 和 Client Secret 连接官方机器人。",
  "config.channels.existing.title": "已配置通道",
  "config.channels.existing.count": "已保存 {{count}} 个",
  "config.channels.existing.empty": "该平台下尚无通道。请在下方添加；凭证写入 OpenCode 通道配置。",
  ...
  "config.channels.field.endpoint": "WebSocket 地址",
  "config.channels.field.accessToken": "访问令牌（可选）",
  "config.channels.field.clientSecret": "Client Secret",
  "config.channels.field.apiBaseUrl": "QQ OpenAPI 地址",
  "config.channels.field.groupRequireMention": "群聊仅在被提及时回复",
  "config.channels.field.proxy": "代理（可选）",
  "config.channels.field.directory": "工作文件夹",
  "config.channels.field.directory.hint": "默认值 ~/.config/opencode/channels/{name}",
  ...
  "config.channels.field.autoReply": "旧版自动回复",
  "config.channels.field.autoReply.hint": "仅在没有项目订阅匹配时自动回复。",
  "config.channels.field.retentionDays": "消息保留天数",
  "config.channels.field.retentionDays.hint": "可选。留空表示永久保留。待处理和未知发送状态不会被清理。",
  "config.channels.field.retentionDays.invalid": "请输入 1 到 3650 的整数，或留空。",
  ...
  "config.channels.test.action": "测试连接",
  "config.channels.test.testing": "测试中…",
  "config.channels.test.success": "连接成功",
  "config.channels.test.failed": "连接失败，请检查机器人凭证和网络设置",
  ...
  "config.im.refresh": "刷新状态",
  "config.im.channels": "已配置渠道",
  "config.im.channels.empty": "尚未配置渠道，请先在消息通道中配置机器人。",
  "config.im.channelHelp":
    "智能体只需指定通道名称和内容。已有私聊会自动复用；新渠道请先给机器人发一条私聊消息，再刷新状态。",
  "config.im.channel.running": "运行中",
  "config.im.channel.offline": "未连接",
  "config.im.channel.disabled": "已禁用",
  "config.im.recipient.ready": "固定接收人已识别",
  "config.im.recipient.missing": "尚未识别固定用户，请从你的账号给机器人发私聊消息。",
  "config.im.recipient.ambiguous": "发现多个私聊用户，服务无法安全确定固定接收人，不会随意发送。",
  "config.im.recipient.unsupported": "此平台尚不支持项目 IM 服务。",
  "config.im.projectHelp": "仅用于管理监听；不会改变项目发送权限。选择会自动保存。",
  "config.im.project": "项目目录",
  "config.im.project.empty": "选择项目",
  "config.im.loading": "正在加载 IM 目标和订阅…",
  "config.im.error": "无法更新 IM 设置",
  "config.im.subscriptions": "订阅",
  "config.im.subscription.emptyCreate": "需要就绪的渠道和项目会话才能创建监听，无需单独授权。",
  "config.im.subscription.session": "项目会话",
  "config.im.subscription.keyword": "关键词子串（可选）",
  "config.im.subscription.keywordFilter": "关键词",
  "config.im.subscription.anyKeyword": "不限制关键词",
  "config.im.subscription.status.active": "运行中",
  "config.im.subscription.status.paused": "已暂停",
  "config.im.subscription.status.stopped": "已停止",
  "config.im.subscription.status.failed": "失败",
  "config.im.subscription.create": "创建订阅",
  "config.im.subscription.created": "订阅已创建",
  "config.im.subscription.none": "此项目暂无订阅。",
  "config.im.subscription.pause": "暂停",
  "config.im.subscription.resume": "恢复",
  "config.im.subscription.stop": "停止",
  ...
  "config.channels.qq.hint":
    "在 QQ 开放平台创建机器人，填写 AppID 和 Client Secret。OpenCode 会自动获取官方 Gateway 并连接。",
  ...
  "config.providers.header": "配置自定义提供商与启停内置提供商",
  "config.providers.matches": "{{count}} 个匹配",
  "config.providers.empty": '没有与 `"{{query}}"` 匹配的提供商。',
  "config.providers.group.enabled": "已启用",
  "config.providers.group.existing": "未启用",
  "config.providers.existingNote": "包括尚未登录，以及已禁用但仍保留登录数据的提供商。",
  ...
  "config.provider.disabled": "这个提供商已被禁用，登录数据已保留。启用它即可恢复连接。",
  "config.provider.toggle.enabledInConfig": "在配置中启用",
  "config.provider.toggle.connected": "已连接",
  "config.provider.toggle.remove": "移除",
  "config.provider.toggle.disable": "禁用",
  "config.provider.toggle.enable": "启用",
  "config.provider.signOut": "退出登录",
  ...
  "config.custom.field.apiKeyDescription": "写入 ~/.config/opencode/opencode.jsonc 的 provider.options.apiKey",
  ...
  "config.custom.models.id.hint": "向上游请求的 ID",
  "config.custom.models.name": "模型标题",
  "config.custom.models.name.hint": "自定义仅用于显示",
  ...
  "config.custom.models.test.envKey": "当前 API 密钥是 {env:VAR} 引用，浏览器无法解析。请临时填入真实 key 后再测试。",
