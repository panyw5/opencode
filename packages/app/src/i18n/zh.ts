...
export const dict = {
  ...
  "config.channels.platform.qq.note": "通过 OneBot 11 WebSocket 连接",
  "config.channels.platform.qq.detail": "通过 NapCat 等兼容 OneBot 11 的客户端连接 QQ 机器人。",
  ...
  "config.channels.field.endpoint": "OneBot WebSocket 地址",
  ...
  "config.channels.test.failed": "连接失败，请检查 App ID 和 App Secret",
  ...
  "config.channels.qq.hint": "运行兼容 OneBot 11 的 QQ 客户端并开启正向 WebSocket 服务，然后填写服务地址。",
