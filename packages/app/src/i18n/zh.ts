...
export const dict = {
  ...
  "config.claws.field.claudeHome": "CLAUDE_CONFIG_DIR",
  "config.claws.field.claudeHomeDescription": "可选配置目录覆盖。默认 `~/.claude`。",
  "config.claws.field.claudeHomePlaceholder": "~/.claude",
  "config.claws.claude.info.title": "Claude 安装与 settings.json",
  "config.claws.claude.info.install": "安装状态",
  "config.claws.claude.info.version": "版本",
  "config.claws.claude.info.binary": "二进制路径",
  "config.claws.claude.info.model": "当前模型",
  "config.claws.claude.info.permissionMode": "权限模式",
  "config.claws.claude.info.defaultMode": "默认模式",
  "config.claws.claude.info.configHome": "配置目录",
  "config.claws.claude.info.settingsPath": "settings.json",
  "config.claws.claude.info.settingsMissing": "不存在",
