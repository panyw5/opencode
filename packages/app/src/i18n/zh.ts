...
export const dict = {
  ...
  "sidebar.im.filter.hint": "来自该通道工作文件夹的会话",
  "sidebar.im.filter.clear": "退出 IM 通道视图",
  "sidebar.im.filter.empty": "该通道工作文件夹中尚无会话。在飞书中给机器人发消息后会出现在此。",
  "sidebar.im.toast.unavailable": "通道不可用",
  "sidebar.im.toast.configure": "请在 Config → 消息通道 中启用或配置该通道。",
  "sidebar.im.toast.opened": "IM 通道：{{name}}",
  "sidebar.im.toast.opened.model": "模型：{{model}}。侧栏已切换为该通道的会话列表。",
  "sidebar.im.toast.opened.runtime": "未设置模型（使用默认）。侧栏已切换为该通道的会话列表。",
