...
export const dict = {
  ...
  "session.mathSwarm.ensure": "重启 {{title}}",
  "session.mathSwarm.reEnable": "重新启用 {{title}}",
  "session.mathSwarm.stop": "停止 {{title}}",
  "session.mathSwarm.ensured": "工人已重启",
  "session.mathSwarm.reEnabled": "工人已重新启用",
  ...
  "session.mathSwarm.reEnable.short": "重新启用",
