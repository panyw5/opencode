export const dict = {
  "scheduled.schedule.every.interval": "كل {{count}} د",
  ...
  "command.session.recent": "الجلسات الحديثة",
  "command.session.recent.description": "افتح أحدث 20 جلسة نشطة في هذا المشروع",
  "session.recent.placeholder": "ابحث في الجلسات الحديثة...",
  "session.recent.empty": "لا توجد جلسات حديثة",
  ...
  "settings.tab.goConfig": "الانتقال إلى الإعدادات",
  ...
  "settings.general.section.searchIndex": "البحث الشامل",
  "settings.general.searchIndex.title": "الفهرس الشامل",
  "settings.general.searchIndex.description":
    "يفهرس رسائل الجلسات على هذا الجهاز للبحث في جميع الجلسات. يؤدي التعطيل إلى مسح الفهرس المحلي دون حذف محتوى الجلسات.",
  "settings.general.searchIndex.status.loading": "جارٍ تحميل حالة الفهرس...",
  "settings.general.searchIndex.status.disabled": "فهرس محتوى الجلسات معطل",
  "settings.general.searchIndex.status.unavailable": "حالة فهرس محتوى الجلسات غير متاحة",
  "settings.general.searchIndex.status.complete": "اكتمل فهرس محتوى الجلسات",
  "settings.general.searchIndex.status.buildingUnknown": "جارٍ إنشاء فهرس محتوى الجلسات...",
  "settings.general.searchIndex.status.building": "جارٍ إنشاء فهرس محتوى الجلسات ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "تقدم فهرسة محتوى الجلسات",
  "settings.general.searchIndex.action.enable": "تمكين",
  "settings.general.searchIndex.action.disable": "تعطيل",
  "settings.general.searchIndex.action.rebuild": "إعادة بناء",
