...
export const dict = {
  "scheduled.schedule.every.interval": "Hvert {{count}}. min",
  ...
  "context.stats.limitReferencedLabel": "Kontekstgrense (referenced from {{source}})",
  ...
  "settings.tab.goConfig": "Gå til konfigurasjon",
  ...
  "settings.general.section.searchIndex": "Globalt søk",
  "settings.general.searchIndex.title": "Global indeks",
  "settings.general.searchIndex.description":
    "Indekser øktmeldinger på denne enheten, slik at du kan søke i alle økter. Deaktivering tømmer den lokale indeksen uten å slette øktinnhold.",
  "settings.general.searchIndex.status.loading": "Laster indeksstatus...",
  "settings.general.searchIndex.status.disabled": "Indeksen over øktinnhold er deaktivert",
  "settings.general.searchIndex.status.unavailable": "Status for indeksen over øktinnhold er utilgjengelig",
  "settings.general.searchIndex.status.complete": "Indeksen over øktinnhold er ferdig",
  "settings.general.searchIndex.status.buildingUnknown": "Bygger indeks over øktinnhold...",
  "settings.general.searchIndex.status.building": "Bygger indeks over øktinnhold ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "Fremdrift for indeksering av øktinnhold",
  "settings.general.searchIndex.action.enable": "Aktiver",
  "settings.general.searchIndex.action.disable": "Deaktiver",
  "settings.general.searchIndex.action.rebuild": "Bygg på nytt",
