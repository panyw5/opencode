export const dict = {
  "scheduled.schedule.every.interval": "{{count}} 分ごと",
  ...
  "command.session.recent": "最近のセッション",
  "command.session.recent.description": "このプロジェクトで最近アクティブな 20 件のセッションを開く",
  "session.recent.placeholder": "最近のセッションを検索...",
  "session.recent.empty": "最近のセッションはありません",
  ...
  "session.todo.mounted": "プロジェクトタスクにリンク済み",
  ...
  "settings.general.section.searchIndex": "グローバル検索機能",
  "settings.general.searchIndex.title": "グローバルインデックス",
  "settings.general.searchIndex.description":
    "すべてのセッションを検索できるよう、このデバイス上でセッションメッセージをインデックス化します。無効にすると、セッション内容は削除せずにローカルインデックスのみを消去します。",
  "settings.general.searchIndex.status.loading": "インデックスの状態を読み込み中...",
  "settings.general.searchIndex.status.disabled": "セッション内容のインデックスは無効です",
  "settings.general.searchIndex.status.unavailable": "セッション内容のインデックス状態を取得できません",
  "settings.general.searchIndex.status.complete": "セッション内容のインデックスが完了しました",
  "settings.general.searchIndex.status.buildingUnknown": "セッション内容のインデックスを作成中...",
  "settings.general.searchIndex.status.building": "セッション内容のインデックスを作成中 ({{indexed}}/{{total}})",
  "settings.general.searchIndex.progress.label": "セッション内容のインデックス作成状況",
  "settings.general.searchIndex.action.enable": "有効にする",
  "settings.general.searchIndex.action.disable": "無効にする",
  "settings.general.searchIndex.action.rebuild": "再構築",
